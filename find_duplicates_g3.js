...
async function findDuplicateNamesG3() {
    console.log("Searching for duplicate names in Grade 3 (2026)...");
    ...
    if (duplicates.length === 0) {
        console.log("No duplicate names found in Grade 3.");
    } else {
        console.log("--- Duplicate Names Found in Grade 3 ---");
